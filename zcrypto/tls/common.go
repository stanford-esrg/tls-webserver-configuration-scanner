...
const (
	...
	minVersion = VersionSSL30 //TODO replace with SSL20
...
const (
	...
	extensionSupportedTLSVersions uint16 = 43
)
...
const (
	Curve_sect163k1 	CurveID = 1
	Curve_sect163r1 	CurveID = 2
	Curve_sect163r2 	CurveID = 3
	Curve_sect193r1 	CurveID = 4
	Curve_sect193r2 	CurveID = 5
	Curve_sect233k1 	CurveID = 6
	Curve_sect233r1 	CurveID = 7
	Curve_sect239k1 	CurveID = 8
	Curve_sect283k1 	CurveID = 9
	Curve_sect283r1 	CurveID = 10
	Curve_sect409k1 	CurveID = 11
	Curve_sect409r1 	CurveID = 12
	Curve_sect571k1 	CurveID = 13
	Curve_sect571r1 	CurveID = 14
	Curve_secp160k1 	CurveID = 15
	Curve_secp160r1	 	CurveID = 16
	Curve_secp160r2 	CurveID = 17
	Curve_secp192k1 	CurveID = 18
	Curve_secp192r1 	CurveID = 19
	Curve_secp224k1 	CurveID = 20
	Curve_secp224r1	 	CurveID = 21
	Curve_secp256k1 	CurveID = 22
	CurveP256 		CurveID = 23
	CurveP384 		CurveID = 24
	CurveP521 		CurveID = 25
	Curve_brainpoolP256r1 	CurveID = 26
	Curve_brainpoolP384r1 	CurveID = 27
	Curve_brainpoolP512r1 	CurveID = 28
	Curve_X25519 		CurveID = 29
	Curve_X448 		CurveID = 30
	Curve_ffdhe2048 	CurveID = 256
	Curve_ffdhe3072	 	CurveID = 257
	Curve_ffdhe4096 	CurveID = 258
	Curve_ffdhe6144 	CurveID = 259
	Curve_ffdhe8192 	CurveID = 260
)
...
var defaultSkipVerify = []PsignatureAndHash{
        PsignatureAndHash{1, 4},
        PsignatureAndHash{1, 5},
        PsignatureAndHash{1, 6},
        PsignatureAndHash{3, 4},
        PsignatureAndHash{3, 5},
        PsignatureAndHash{3, 6},
        PsignatureAndHash{4, 8},
        PsignatureAndHash{5, 8},
        PsignatureAndHash{6, 8},
        PsignatureAndHash{7, 8},
        PsignatureAndHash{8, 8},
        PsignatureAndHash{1, 2},
        PsignatureAndHash{3, 2},
}
...
type Config struct {
	...
	// Time to delay the defaults scan (in seconds)
	StartDelay int

	// Time to delay each handshake in defaults scan (in seconds)
	HandshakeDelay int

	// Time to delay between session resumption handshakes in defaults scan (in seconds)
	SessionResumptionDelay int
	...
	//Added in to replicate Go 1.4 behavior
	...
	SignatureAndHashes []PsignatureAndHash
...
func (c *Config) compressMethods() []uint8 {
	s := c.CompressMethods
	if s == nil {
		s = []uint8{0}
	}
...
func (c *Config) maxVersion() uint16 {
	// Default will be 1.2 because 1.3 is
...
func (c *Config) mutualVersion(vers uint16) (uint16, bool) {
	...
	if vers < minVersion {
		//Special TLS1.3 case
		if vers == VersionTLS12 && minVersion == VersionTLS13 {
			return vers, true
		}
		return 0, false
	}
...
func convertPshToSh (sh []PsignatureAndHash) []signatureAndHash {
	new_sh := make([]signatureAndHash, len(sh))
	for i:= 0; i < len(sh); i++ {
		sigHash := sh[i]
		new_sh[i] = signatureAndHash{sigHash.Signature, sigHash.Hash}
	}
	return new_sh
}
...
func (c *Config) signatureAndHashesForServer() []signatureAndHash {
	if c != nil && c.SignatureAndHashes != nil {
		return convertPshToSh(c.SignatureAndHashes)
	}
...
func (c *Config) signatureAndHashesForClient() []signatureAndHash {
	...
	if c.InsecureSkipVerify {
		return convertPshToSh(defaultSkipVerify)
	}
...
const (
	...
	ECDSAWithP1AndSHA1 SignatureScheme = 0x0203
