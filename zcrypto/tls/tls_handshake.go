...
type ClientHello struct {
	...
	MultiStapling        bool                `json:"multi_stapling"`
...
type ServerHello struct {
	...
	SNISupport                  bool              `json:"SNISupport"`
}
...
func (c SimpleCertificate) MarshalJSON() ([]byte, error) {
	aux := struct {
		Raw  []byte `json:"raw,omitempty"`
	}{
		Raw: c.Raw,
...
func (m *clientHelloMsg) MakeLog() *ClientHello {
	...
	ch.MultiStapling = m.multiStapling
...
func (m *serverHelloMsg) MakeLog() *ServerHello {
	...
	sh.SupportedVersions = m.supportedVersions
	...
	sh.MultiStapling = m.multiStapling
